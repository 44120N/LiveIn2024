...
function Carousel({title, src, none}) {
  const content = []
  ...
  const listContent = content.map((item, index) => (
    ...
    >
      <div className="banner" style={{backgroundImage: `url(${item.src})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "bottom center"}}>
        {none ? null : (
